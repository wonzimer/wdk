...
import { BaseErc20Factory } from '@wonzimer-nft/core/dist/typechain'
...
export function chainIdToNetworkName(chainId: number): string {
  ...
  invariant(false, `chainId ${chainId} not officially supported by the Wonzimer Protocol`)
}
...
/**
 * Signs a Wonzimer Permit Message as specified by EIP-712
 *
 * @param owner
 * @param toAddress
 * @param mediaId
...
/**
 * Recovers the address of the private key that signed the Wonzimer Permit Message
 *
 * @param toAddress
 * @param mediaId
 * @param nonce
...
/**
 * Recovers the address of the private key that signed a Wonzimer MintWithSig Message
 *
 * @param contentHash
 * @param metadataHash
...
/**
 * Signs a Wonzimer MintWithSig Message as specified by EIP-712
 *
 * @param owner
 * @param contentHash
 * @param metadataHash
